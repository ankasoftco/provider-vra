...
The [provider-vraprovider](https://github.com/crossplane/provider-vraprovider) repository can be
used as a starting point for new providers. For [terrajet](https://github.com/crossplane/terrajet)-based providers, the
[provider-jet-vraprovider](https://github.com/crossplane-contrib/provider-jet-vraprovider) is
available.
...
- [ ]  Code is licensed under the [Apache 2.0
  License](https://github.com/crossplane/provider-vraprovider/blob/main/LICENSE)
...
- [ ]  Update
  [OWNERS.md](https://github.com/crossplane/provider-vraprovider/blob/main/OWNERS.md)
...
- [ ]  Ensure `hack/boilerplate.go.txt` (used in Code generation) includes
  ...
  [https://github.com/crossplane/provider-vraprovider/blob/main/hack/boilerplate.go.txt](https://github.com/crossplane/provider-vraprovider/blob/main/hack/boilerplate.go.txt)
...
The [provider-vraprovider](https://github.com/crossplane/provider-vraprovider)
...
- [ ] Create a [Crossplane
  ...
  configuration (see
  [package/crossplane.yaml)](https://github.com/crossplane/provider-vraprovider/blob/main/package/crossplane.yaml)
...
- [ ] Utilize GitHub workflows from
  <https://github.com/crossplane/provider-vraprovider/tree/main/.github/workflows>
...
- [ ] Enable Issues on your project and configure Issue vraproviders (examples at:
  [.github/ISSUE_TEMPLATE](https://github.com/crossplane/provider-vraprovider/tree/master/.github/ISSUE_TEMPLATE))
- [ ] Create Pull Request VraProviders: (example:
  [PULL_REQUEST_TEMPLATE.md](https://github.com/crossplane/provider-vraprovider/blob/master/.github/PULL_REQUEST_TEMPLATE.md))
