...
import (
	...
	"github.com/crossplane/provider-vra/apis"
	"github.com/crossplane/provider-vra/apis/v1alpha1"
	vra "github.com/crossplane/provider-vra/internal/controller"
	"github.com/crossplane/provider-vra/internal/controller/features"
)

func main() {
	var (
		app            = kingpin.New(filepath.Base(os.Args[0]), "vRA support for Crossplane.").DefaultEnvars()
	...
	kingpin.FatalIfError(vra.Setup(mgr, o), "Cannot setup vRA controllers")
