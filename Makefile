# ====================================================================================
# Setup Project
PROJECT_NAME := provider-vraprovider
...
XPKGS = provider-vraprovider
-include build/makelib/xpkg.mk

# NOTE(hasheddan): we force image building to happen prior to xpkg build so that
# we ensure image is present in daemon.
xpkg.build.provider-vraprovider: do.build.images
...
dev: $(KIND) $(KUBECTL)
	...
	@$(INFO) Installing Provider VraProvider CRDs
	@$(KUBECTL) apply -R -f package/crds
	@$(INFO) Starting Provider VraProvider controllers
...
# This target prepares repo for your provider by replacing all "vraprovider"
